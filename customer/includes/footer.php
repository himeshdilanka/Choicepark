<footer class="page-footer">
	...
	<div class="footer-nav">
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				Address : No,10 Galle Road, Colombo 02 No 12,Colombo Road,Kurunegala<br>
				Branches : Colombo,Kurunegala
			</address>
				<div class="phone">
					Telephone:
					<a class="phone__number" href="tel:0123456789"> 0370123456</a>
				</div>
				<div class="email">
					Email:
					<a href="uviudhara@gmail.com" class="email__addr">Choicepark@gmail.com</a>
				</div>
			</div>
	...
	<div class="page-footer__subline">
		<div class="container clearfix">
			...
			<div class="copyright">
				&copy;Copyright ©2022 Choicepark&trade;
			</div>

			<div class="developer">
				Design by Choicepark..
			</div>
